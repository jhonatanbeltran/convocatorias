<%-- 
    Document   : Verbecas
    Created on : 20/05/2021, 10:49:40 PM
    Author     : german
--%>
...
<script type="text/javascript" src="../DataTables/datatables.min.js"></script>
  ...
  <h1 class="display-4 text-muted"> Becas...</h1>
  ...
  <p class="lead">
   <ul class="nav">
             ...
             <%
        String becas=(String)(request.getSession().getAttribute("becas"));
        int id=Integer.parseInt( request.getParameter("id"));
        
        //Aplicante prueba=(Aplicante) (request.getSession().getAttribute("user"));
       // String cedula=(String)(request.getSession().getAttribute("ced"));
