<%-- 
    Document   : InicioAplicante
    Created on : 19/05/2021, 08:46:09 PM
    Author     : german
--%>

<%@page import="DTO.Aplicante"%>
...
<html>
    ...
    <head>
     ...
     <%
        Aplicante editar=(Aplicante)(request.getSession().getAttribute("user"));
       String saludo= "Hola! " + editar.getPrimerNombre() + " " + editar.getPrimerapellido();
       String cedula=(editar.getCedula())+"";
       String nombre= editar.getPrimerNombre();
        %>
  ...
  <li class="nav-item">
      <!--<a href='Eliminar?name="+ pl.getId() + "'>eliminar</a>-->
    <a class="nav-link text-primary" href="VerBecas?id=<%=cedula%>" >Ver Becas</a>
  </li>
  <li class="nav-item">
      <!--<a href='Eliminar?name="+ pl.getId() + "'>eliminar</a>-->
    <a class="nav-link text-primary" href="VerAplicaciones?id=<%=cedula%>" >Ver Aplicanciones</a>
  </li>
   <li class="nav-item">
          ...
          <div class="card-body">
            <form >
                ...
                String nombres=  editar.getPrimerNombre() + " " + editar.getSegundoNombre();
                 ...
                 String correo = editar.getCorreo();
                %>
              <div class="mb-4">
